...
@XmlRootElement(name = "FindSsoUsers", namespace = "http://www.ultipro.com/services/employeessouser")
public class FindSsoUsers {

    @XmlElementRef(name = "query", namespace = "http://www.ultipro.com/services/employeessouser", type = JAXBElement.class, required = false)
