...
@XmlRootElement(name = "GetEmploymentInformationByEmployeeIdentifier", namespace = "http://www.ultipro.com/services/employeeemploymentinformation")
public class GetEmploymentInformationByEmployeeIdentifier {

    @XmlElementRef(name = "employeeIdentifier", namespace = "http://www.ultipro.com/services/employeeemploymentinformation", type = JAXBElement.class, required = false)
