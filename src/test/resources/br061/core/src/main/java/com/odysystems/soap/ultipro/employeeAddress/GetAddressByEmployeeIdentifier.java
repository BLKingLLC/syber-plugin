...
@XmlRootElement(name = "GetAddressByEmployeeIdentifier", namespace = "http://www.ultipro.com/services/employeeaddress")
public class GetAddressByEmployeeIdentifier {

    @XmlElementRef(name = "employeeIdentifier", namespace = "http://www.ultipro.com/services/employeeaddress", type = JAXBElement.class, required = false)
