...
@XmlRootElement(name = "GetGlobalEmployeeByEmployeeIdentifier", namespace = "http://www.ultipro.com/services/employeeglobalnewhire")
public class GetGlobalEmployeeByEmployeeIdentifier {

    @XmlElementRef(name = "employeeIdentifier", namespace = "http://www.ultipro.com/services/employeeglobalnewhire", type = JAXBElement.class, required = false)
