...
@XmlRootElement(name = "GetJobByEmployeeIdentifier", namespace = "http://www.ultipro.com/services/employeejob")
public class GetJobByEmployeeIdentifier {

    @XmlElementRef(name = "employeeIdentifier", namespace = "http://www.ultipro.com/services/employeejob", type = JAXBElement.class, required = false)
