...
@XmlRootElement(name = "FindJobs", namespace = "http://www.ultipro.com/services/employeejob")
public class FindJobs {

    @XmlElementRef(name = "query", namespace = "http://www.ultipro.com/services/employeejob", type = JAXBElement.class, required = false)
