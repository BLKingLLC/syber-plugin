...
@XmlRootElement(name = "GetSsoUserByEmployeeIdentifier", namespace = "http://www.ultipro.com/services/employeessouser")
public class GetSsoUserByEmployeeIdentifier {

    @XmlElementRef(name = "employeeIdentifier", namespace = "http://www.ultipro.com/services/employeessouser", type = JAXBElement.class, required = false)
