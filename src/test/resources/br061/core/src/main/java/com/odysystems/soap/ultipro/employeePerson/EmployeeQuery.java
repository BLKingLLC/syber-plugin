...
public class EmployeeQuery {
	...
	public String toString() {
		return "EmployeeQuery [companyCode=" + companyCode + ", companyName=" + companyName + ", country=" + country
				+ ", employeeNumber=" + employeeNumber + ", firstName=" + firstName + ", formerName=" + formerName
				+ ", fullOrPartTime=" + fullOrPartTime + ", job=" + job + ", lastHire=" + lastHire + ", lastName="
				+ lastName + ", location=" + location + ", organizationLevel1=" + organizationLevel1
				+ ", organizationLevel2=" + organizationLevel2 + ", organizationLevel3=" + organizationLevel3
				+ ", organizationLevel4=" + organizationLevel4 + ", originalHire=" + originalHire + ", pageNumber="
				+ pageNumber + ", pageSize=" + pageSize + ", payGroup=" + payGroup + ", status=" + status
				+ ", supervisorLastName=" + supervisorLastName + ", terminationDate=" + terminationDate
