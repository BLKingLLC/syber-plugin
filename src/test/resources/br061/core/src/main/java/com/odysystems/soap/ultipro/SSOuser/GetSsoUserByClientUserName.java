...
@XmlRootElement(name = "GetSsoUserByClientUserName", namespace = "http://www.ultipro.com/services/employeessouser")
public class GetSsoUserByClientUserName {

    @XmlElementRef(name = "clientUserName", namespace = "http://www.ultipro.com/services/employeessouser", type = JAXBElement.class, required = false)
