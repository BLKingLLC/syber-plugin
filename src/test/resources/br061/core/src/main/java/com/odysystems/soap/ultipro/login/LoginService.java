 ...
 * 
 */
@WebServiceClient(name = "LoginService", targetNamespace = "http://tempuri.org/", wsdlLocation = "https://service4.ultipro.com/services/LoginService")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("https://service4.ultipro.com/services/LoginService");
     ...
     */
    @WebEndpoint(name = "WSHttpBinding_ILoginService")
    public ILoginService getWSHttpBindingILoginService() {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_ILoginService"), ILoginService.class);
    }
     ...
     */
    @WebEndpoint(name = "WSHttpBinding_ILoginService")
    public ILoginService getWSHttpBindingILoginService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_ILoginService"), ILoginService.class, features);
    }
