...
@XmlRootElement(name = "FindPeople", namespace = "http://www.ultipro.com/services/employeeperson")
public class FindPeople {

    @XmlElementRef(name = "query", namespace = "http://www.ultipro.com/services/employeeperson", type = JAXBElement.class, required = false)
