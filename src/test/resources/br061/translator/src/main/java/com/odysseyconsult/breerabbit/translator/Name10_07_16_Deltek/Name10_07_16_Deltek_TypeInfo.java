////////////////////////////////////////////////////////////////////////
//
// Name10_07_16_Deltek_typeinfo.java
//
...
public class Name10_07_16_Deltek_TypeInfo
{
	// namespaces indices
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _CO_CODE = _altova_mi_altova_RowsType.begin ;
		public static final int _BATCH_ID = 2 ;
		public static final int _FILE__ = 3 ;
		public static final int _PAY__ = 4 ;
		public static final int _SHIFT = 5 ;
		public static final int _SPECIAL_ACTION = 6 ;
		public static final int _REG_HOURS = 7 ;
		public static final int _O_T_HOURS = 8 ;
		public static final int _HOURS_3_CODE = 9 ;
		public static final int _HOURS_3_AMOUNT = 10 ;
		public static final int _HOURS_4_CODE = 11 ;
		public static final int _HOURS_4_AMOUNT = 12 ;
		public static final int _REG_EARNINGS = 13 ;
		public static final int _O_T_EARNINGS = 14 ;
		public static final int _EARNINGS_3_CODE = 15 ;
		public static final int _EARNINGS_3_AMOUNT = 16 ;
		public static final int _EARNINGS_4_CODE = 17 ;
		public static final int _EARNINGS_4_AMOUNT = 18 ;
		public static final int _EARNINGS_5_CODE = 19 ;
		public static final int _EARNINGS_5_AMOUNT = 20 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator
	{
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[1] = new MemberInfo (binder, "", "CO CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[2] = new MemberInfo (binder, "", "BATCH ID", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[3] = new MemberInfo (binder, "", "FILE #", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[4] = new MemberInfo (binder, "", "PAY #", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[5] = new MemberInfo (binder, "", "SHIFT", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[6] = new MemberInfo (binder, "", "SPECIAL ACTION", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[7] = new MemberInfo (binder, "", "REG HOURS", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);
			members[8] = new MemberInfo (binder, "", "O_T HOURS", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);
			members[9] = new MemberInfo (binder, "", "HOURS 3 CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[10] = new MemberInfo (binder, "", "HOURS 3 AMOUNT", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);
			members[11] = new MemberInfo (binder, "", "HOURS 4 CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[12] = new MemberInfo (binder, "", "HOURS 4 AMOUNT", _altova_ti_altova_RowsType, _altova_ti_altova_decimalType, 0, 0, 1);
			members[13] = new MemberInfo (binder, "", "REG EARNINGS", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[14] = new MemberInfo (binder, "", "O_T EARNINGS", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[15] = new MemberInfo (binder, "", "EARNINGS 3 CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[16] = new MemberInfo (binder, "", "EARNINGS 3 AMOUNT", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[17] = new MemberInfo (binder, "", "EARNINGS 4 CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[18] = new MemberInfo (binder, "", "EARNINGS 4 AMOUNT", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[19] = new MemberInfo (binder, "", "EARNINGS 5 CODE", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[20] = new MemberInfo (binder, "", "EARNINGS 5 AMOUNT", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);

			members[21] = new MemberInfo (binder, "", "", _altova_ti_altova_stringType, _altova_ti_altova_string2, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

			members[22] = new MemberInfo (binder, "", "", _altova_ti_altova_decimalType, _altova_ti_altova_decimal, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

		}

		public MemberInfo[] createMembers(InfoBinderInterface binder) {

			MemberInfo members[] = new MemberInfo[23];
