...
public class Text_file_TypeInfo
{
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _Field14 = _altova_mi_altova_RowsType.begin ;
		public static final int _Field13 = 2 ;
		public static final int _Field12 = 3 ;
		public static final int _Field1 = 4 ;
		public static final int _Field5 = 5 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator
	{
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[1] = new MemberInfo (binder, "", "Field14", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[2] = new MemberInfo (binder, "", "Field13", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[3] = new MemberInfo (binder, "", "Field12", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[4] = new MemberInfo (binder, "", "Field1", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[5] = new MemberInfo (binder, "", "Field5", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
