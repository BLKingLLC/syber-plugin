////////////////////////////////////////////////////////////////////////
//
// Deltek_GCS_Payroll_Output_typeinfo.java
//
...
public class Deltek_GCS_Payroll_Output_TypeInfo
{
	// namespaces indices
	...
	public static class _altova_mi_altova_RowsType {
		...
		public static final int _BATCH_DESCRIPTION = 4 ;
		public static final int _Name = 5 ;
		public static final int _Pay__ = 6 ;
		public static final int _Tax_Frequency = 7 ;
		public static final int _Shift = 8 ;
		public static final int _Special_Action = 9 ;
		public static final int _Reg_Hours = 10 ;
		public static final int _O_T_Hours = 11 ;
		public static final int _Paid_Time_Off_Hours_3 = 12 ;
		public static final int _Holiday_Hours_4 = 13 ;
		public static final int _Reg_Earnings = 14 ;
		public static final int _O_T_Earnings = 15 ;
...
// Array of all types with pointers to members:
	...
	private static class MemberInfoCreator
	{
		private void initMembers0(InfoBinderInterface binder, MemberInfo[] members) {
			...
			members[4] = new MemberInfo (binder, "", "BATCH DESCRIPTION", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[5] = new MemberInfo (binder, "", "Name", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[6] = new MemberInfo (binder, "", "Pay #", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[7] = new MemberInfo (binder, "", "Tax Frequency", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[8] = new MemberInfo (binder, "", "Shift", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[9] = new MemberInfo (binder, "", "Special Action", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[10] = new MemberInfo (binder, "", "Reg Hours", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[11] = new MemberInfo (binder, "", "O_T Hours", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[12] = new MemberInfo (binder, "", "Paid Time Off Hours 3", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[13] = new MemberInfo (binder, "", "Holiday Hours 4", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[14] = new MemberInfo (binder, "", "Reg Earnings", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);
			members[15] = new MemberInfo (binder, "", "O_T Earnings", _altova_ti_altova_RowsType, _altova_ti_altova_stringType, 0, 0, 1);

			members[16] = new MemberInfo (binder, "", "", _altova_ti_altova_stringType, _altova_ti_altova_string2, 0|MemberInfo.IS_ATTRIBUTE, 1, 1);

		}

		public MemberInfo[] createMembers(InfoBinderInterface binder) {

			MemberInfo members[] = new MemberInfo[17];
