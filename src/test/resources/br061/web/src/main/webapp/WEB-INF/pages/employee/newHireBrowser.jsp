...
<head>
<title><fmt:message key="newHireBrowser.title" /></title>
...
<div class="col-sm-3">
	<h2>
		<fmt:message key="newHireBrowser.heading" />
	</h2>
	<p>
		<fmt:message key="newHireBrowser.message" />
	</p>
</div>
<!-- <div class="col-sm-7"> -->
...
<div class="row">
	...
	<form method="get" action="${ctx}/employee/newHireBrowser"
...
<div class="row">
	<form:form commandName="create" method="post" action="returnedEmployee"
		id="returnedEmployee" autocomplete="off"
	...
	<display:table name="employeeList.employees"
		...
		<display:column property="employee.employeeNumber.value"
			...
			url="/employee/ultiPro" paramId="empID"
			paramProperty="employee.employeeNumber.value" />
		...
		<display:column property="person.alternateEmailAddress.value"
			sortable="false" titleKey="person.alternateEmailAddress" />
		<display:column value="Create"
			class="btn btn-default btn-lg btn-block"
			url="/employee/returnedEmployee" paramId="empID"
			paramProperty="employee.employeeNumber.value" />
